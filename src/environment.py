...
class SO101BaseEnv(gymnasium.Env):
    ...
    def __init__(self, render_mode=None, reward_type="dense", control_mode="delta_end_effector"):
        ...
        self.raw_motor_ctrl_buffer = np.zeros(5, dtype=np.float64)
    ...
    def _update_fb_buffer(self):
        self.fb_obs_buffer[0:29] = self._get_robot_state()
...
class SO101LiftEnv(SO101BaseEnv):
    ...
    def _get_obs(self):
        ...
        self.obs_buffer[0:29] = self.fb_obs_buffer[0:29].copy()
